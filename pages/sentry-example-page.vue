    ...
    <div>
      <main>
        ...
        <p class="description">
          ...
          <a
            target="_blank"
            href="https://devrafaelffz.sentry.io/issues/?project=4509771338547202"
          >Issues Page</a>. For more details about setting up Sentry,
          <a
            target="_blank"
        ...
        <div v-else-if="!isConnected" class="connectivity-error">
          <p>
            ...
            errors from being captured. Try disabling your ad-blocker to complete the
            test.
          </p>
        </div>
